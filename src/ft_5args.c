...
/*   Updated: 2023/06/27 18:14:05 by fsantama         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	ft_5args_2(ps_list *ps, int *n)
{
	...
	else if (n[0] > n[4] && n[1] > n[4] && n[2] > n[4] && n[3] > n[4])
	{
		ft_rra(ps);
		ft_pb(ps);
	}
...
//	{
		if (n[0] < n[1] && n[0] < n[2] && n[0] < n[3] && n[0] < n[4])
			ft_pb(ps);
		else if (n[0] > n[1] && n[1] < n[2] && n[1] < n[3] && n[1] < n[4])
		{
			ft_sa(ps->sa);
			ft_pb(ps);
		}
		else if (n[0] > n[2] && n[1] > n[2] && n[2] < n[3] && n[2] < n[4])
		{
			ft_ra(ps);
			ft_sa(ps->sa);
			ft_pb(ps);
